  ...
  <div>
    ...
    <div class="mt10 tableBg" style="overflow-x: auto">
      <el-table :data="allOrderData" id="exportTable" v-loading="loading" element-loading-text="拼命加载中" border style="width: 100%;font-size: 15px;"
        ...
        <el-table-column prop="ServiceType" label="订单类型" align="center" width="130">
          <template slot-scope="scope">
        ...
        <el-table-column prop="ProductName" label="产品名称" align="center" width="120" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="Asin" label="产品ASIN" align="center" width="130"></el-table-column>
        ...
        <el-table-column prop="UnitPriceSerCharge" label="服务费单价" align="center" width="110"></el-table-column>
        ...
        <el-table-column prop="OrderTime" label="下单时间" align="center" width="170"></el-table-column>
